...
<section>
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <a href="${pageContext.request.contextPath}/organizer/checkpoints/add?routeId=${route.routeId}" class="btn btn-primary">
                    <i class="fa fa-plus"></i> Add Checkpoint
                </a>
                <a href="${pageContext.request.contextPath}/organizer/routes/view?id=${route.routeId}" class="btn btn-info">
