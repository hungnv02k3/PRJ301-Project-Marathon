...
<html lang="en">
<head>
    <title><c:choose><c:when test="${event != null}">Edit Event</c:when><c:otherwise>Create New Event</c:otherwise></c:choose></title>
                    ...
                    <div class="panel-body">
                        <form method="post" action="${pageContext.request.contextPath}/organizer/events/<c:choose><c:when test="${event != null}">edit</c:when><c:otherwise>add</c:otherwise></c:choose>">
                            ...
                            <div class="form-group">
                                ...
                                <a href="${pageContext.request.contextPath}/organizer/events" class="btn btn-default" style="margin-top: 0; margin-bottom: 0; vertical-align: top;">
